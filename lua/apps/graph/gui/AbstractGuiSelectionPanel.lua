        ...
        __index = {
            ...
            updateElements = function(self)
                if self:sanityCheck() then
                    ...
                    local hasElements = not not (elements and next(elements)) -- need to convert to bool, I don't know what Credne was thinking (or something changed with Factorio 2.0?)
